...
// @contract_interface
// namespace ITicketMint {
//     func ticketPrice() -> (price : Uint256) {
//     }
// }
...
func constructor{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    name: felt, symbol: felt, owner: felt, img_URI: felt
    // name: felt, symbol: felt, owner: felt, img_URI: felt, eth_address: felt
) {
    ERC721.initializer(name, symbol);
    ERC721Enumerable.initializer();
    Ownable.initializer(owner);
    ERC721_image_uri.write(img_URI);
...
func mint{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
    ...
    // let tokenURI = ERC721_image_uri.read();
    let (tokenURI: felt) = imageURI();
    setTokenURI(tokenId, tokenURI);
    // setTokenURI(tokenId, ERC721_image_uri.read());
    return ();
}
